...
$sql="INSERT INTO tblstudents(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:mobileno,:status)";
...
<label for="empcode">Student Code(Must be unique - USN)</label>
