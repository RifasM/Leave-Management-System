...
<?php 
$status=1;
$sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.EmpId,tblstudents.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblstudents on tblleaves.empid=tblstudents.id where tblleaves.Status=:status order by lid desc";
