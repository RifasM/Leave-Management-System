...
$sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.EmpId,tblstudents.id,tblstudents.Gender,tblstudents.Phonenumber,tblstudents.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblstudents on tblleaves.empid=tblstudents.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
      ...
      ?>
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Student Name :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Student ID (USN) :</b></td>
