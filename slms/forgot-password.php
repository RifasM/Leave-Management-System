        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">SLMS | Student Leave Management System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li ><a class="waves-effect waves-grey" href="index.php"><i class="fa fa-sign-in material-icons"></i>Student Login</a></li>
                    <li ><a class="waves-effect waves-grey" href="forgot-password.php"><i class="fa fa-key"></i>Student Password Recovery</a></li>

                       <li ><a class="waves-effect waves-grey" href="admin/"><i class="fa fa-lock material-icons"></i>Admin Login</a></li>
                </ul>
          <div class="footer">
                    <p class="copyright"><a href="http://cmrit.ac.in">SLMS </a>©</p>
