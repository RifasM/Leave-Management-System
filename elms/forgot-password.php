        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li ><a class="waves-effect waves-grey" href="index.php"><i class="fa fa-sign-in material-icons"></i>Employe Login</a></li>
                    <li ><a class="waves-effect waves-grey" href="forgot-password.php"><i class="fa fa-key"></i>Employee Password Recovery</a></li>

                       <li ><a class="waves-effect waves-grey" href="admin/"><i class="fa fa-lock material-icons"></i>Admin Login</a></li>

                </ul>
          <div class="footer">
                    <p class="copyright"><a href="http://cmrit.ac.in/">ELMS </a>©</p>
